...
#define UBBD_DEV_FEATURE_WRITECACHE	1 << 0
#define UBBD_DEV_FEATURE_FUA		1 << 1
#define UBBD_DEV_FEATURE_DISCARD	1 << 2
#define UBBD_DEV_FEATURE_WRITE_ZEROS	1 << 3
